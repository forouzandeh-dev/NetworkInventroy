...
namespace NetworkInventory.WebApp.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,type,location,InstallationDate")] Devices devices)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,type,location,InstallationDate")] Devices devices)
        {
            if (id != devices.Id)
            {
                return NotFound();
